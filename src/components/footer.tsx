	...
	return (
		<footer className='bg-mbceYellow/90 flex min-h-[10vh] items-center relative'>
			<div className='absolute w-full z-10'>
				<div
					className={cn(
						'flex items-center lg:container lg:pl-4 lg:pr-4 xl:pl-4 xl:pr-4 2xl:pl-0 2xl:pr-0 text-white',
						heavitasFont.className,
					)}
				>
					{/* Copy right */}
					<div className='basis-1/2 text-[10px] pl-5 2xl:pl-0'>
						<div className='text-3xs xxsm:text-2xs xsm:text-1.5xs sm:text-xs md:text-sm lg:text-xba'>
							<p className='flex items-center'>©2024</p>
							<p className='lg:pr-24 xl:pr-0'>
								Mantenimiento, Proyectos y <br className='lg:hidden' />{' '}
					...
					<div className='flex flex-col basis-1/2 pr-5 2xl:pr-0'>
						<ul className='flex items-center justify-end gap-2 xxsm:gap-3 xsm:gap-5'>
							<li>
								<Link
