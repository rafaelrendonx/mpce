			...
			<div className='space-y-10 font-roboto'>
				...
				<section className='px-3 lg:container lg:px-4 2xl:px-0 flex flex-col md:flex-row gap-10 md:gap-20 *:min-h-[40vh] *:md:min-h-[65vh]'>
					<div className='space-y-5 size-full flex flex-col items-center justify-center'>
						{/* Title */}
						<h2 className={cn('text-4xl font-bold tracking-tight text-center')}>
							Misión
						</h2>
						{/* Data */}
						<p
							className={cn(
								'text-balance tracking-wide text-center leading-relaxed lg:text-xl',
							)}
						>
				...
				<section className='px-3 pb-10 lg:container lg:px-4 2xl:px-0 flex flex-col md:flex-row gap-10 md:gap-20 *:min-h-[40vh] *:md:min-h-[65vh]'>
					<div className='space-y-5 size-full flex flex-col items-center justify-center'>
						...
						>
							<li>
								<span className='font-bold'>Calidad:</span> Nos comprometemos a
								ofrecer servicios de la más alta calidad, cumpliendo con los
								estándares y regulaciones de la industria.
							</li>
							<li>
								<span className='font-bold'>Innovación:</span> Buscamos
								constantemente nuevas y mejores formas de satisfacer las
								necesidades de nuestros clientes.
							</li>
							<li>
								<span className='font-bold'>Sostenibilidad:</span> Nos
								esforzamos por minimizar nuestro impacto en el medio ambiente en
							...
							<li>
								<span className='font-bold'>Compromiso:</span> Nos esforzamos
								por cumplir y superar las expectativas de nuestros clientes en
								cada proyecto.
							</li>
						</ul>
					</div>
